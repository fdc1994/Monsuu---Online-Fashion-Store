...
<div class="jumbotron jumbotron-fluid text-center mt-5 mb-0" >
  ...
  <div class="container mt-0 mb-0">
    <h1 class="display-3 lead"> <strong>Inicio de Sessão</strong></h1>
    <p class="lead">Para usufruir de imediato de todas as funcionalidades do nosso site, inicie sessão.</p>
    <p class="lead">Caso ainda não disponha de uma conta, poderá criar uma <strong><a href="registo.php">aqui.</a></strong></p>
      ...
      <div class="row text-center mt-0 mb-0">
        ...
        <div class="row">
            <div class="col-2"></div>
            <div class="col-8">
              <form class="" action="admin/validarlogin.php?redirect=<?php echo $redirect?>&id=<?php echo $id?>" method="POST">
