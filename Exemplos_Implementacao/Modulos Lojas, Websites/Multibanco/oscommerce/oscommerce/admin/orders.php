...
<?php
	...
	?>
      ...
      <tr>
	   <td class="main"><b><?php echo ENTRY_PAYMENT_METHOD; ?></b>
           <?php echo $order->info['payment_method']; ?></td>
	  <tr>
        <td class="main"><table border="1" cellspacing="0" cellpadding="5">
          <tr>
            <td class="smallText" align="center"><b><?php echo "Entidade"; ?></b></td>
            <td class="smallText" align="center"><b><?php echo "Referência"; ?></b></td>
            <td class="smallText" align="center"><b><?php echo "Valor"; ?></b></td>
            
          </tr>
		  <tr>
		  <?php 
			
			echo '<td class="smallText" align="center">' . MODULE_PAYMENT_TRANSFERENCIA_ENTIDADE.'</td>';
		?>
		
		<?php $oID2 = tep_db_prepare_input($HTTP_GET_VARS['oID']); ?>
		<?php   echo '<td class="smallText" align="center">'.GenerateMbRef($oID2, str_replace ("€","",str_replace ("EUR","",strip_tags($order->totals[sizeof($order->totals)-1]['text'])))).'</td>';
		   
		   
		   ?>
		   
		   <?php 
		   $orderValueTotal = $order->totals[sizeof($order->totals)-1]['text'];
			$orderValueTotal =strip_tags($orderValueTotal);
		    echo '<td class="smallText" align="center">' .$orderValueTotal.'</td>';
		   ?>
		  </table></td>
        <td>
