    ...
    <div class="jumbotron text-center mb-0 mt-5">
        ...
        <div class="container mb-5">
            ...
            <div class="container">
                <div class="row mb-1">
                    <form class=""
                        action="inserirDados.php?pagina=<?php echo($pagina)?>&id=<?php echo($row['id'])?>&orderBy=<?php echo($orderBy)?>"
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="row mt-3">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="colecao" required>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col">
                                    ...
                                    <select class="form-control" id="exampleFormControlSelect1" name="novidade" required>
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    ...
                                    <textarea class="form-control" type="textarea" rows="5"
                                        name="fichaTecnica" required></textarea>
                                </div>
                            </div>
                        </div>
