                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="media d-flex">
                                    ...
                                    <div class="media-body  text-right">
                                        <h5 class="lead"><?php echo $rowCart['SUM(quantidade)']?> </h5>
                                        <span>Produtos</span>
                                    </div>
                                </div>
                            </div>
...
include("ligacao.php");
  ...
  ?>
    ...
    <table class="table table-responsive table-bordered table-hover table-fit">
      ...
      ?>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td scope="row" class="align-middle"><?php echo $row['stockUnico'] ?></td>
                <td scope="row" class="align-middle"><?php echo $row['stockS'] ?></td>
                <td scope="row" class="align-middle"><?php echo $row['stockM'] ?></td>
                <td scope="row" class="align-middle"><?php echo $row['stockL'] ?></td>
                <td scope="row" class="align-middle"><?php echo $row['stockXL'] ?></td>
