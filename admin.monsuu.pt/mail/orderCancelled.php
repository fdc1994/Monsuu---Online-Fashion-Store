        ...
        <tbody>
            <tr>
                <td valign="top"
                    ...
                    <table class="container text-center" border="0" cellpadding="0" cellspacing="0"
                        style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%; text-align: center !important;">
                        <tbody>
                            <tr>
                                <td align="center"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;"
                                                    ...
                                                    <img class="img-fluid" width="600" height="250"
                                                        src="http://images.monsuu.pt/bannerNew.png"
                                                        alt="Image Not Available"
                                                        style="height: auto; line-height: 100%; outline: none; text-decoration: none; width: 100%; max-width: 100%; border: 0 none;">
                                                    <table class="s-0 w-100" border="0" cellpadding="0" cellspacing="0"
                                                        style="width: 100%;">
                                                        <tbody>
                                                            <tr>
                                                                <td height="0"
                                                                    style="border-spacing: 0px; border-collapse: collapse; line-height: 0; font-size: 0; width: 100%; height: 0; margin: 0;"
                                                                    align="left">
                                                                                    ...
                                                                                    <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;"
                                                                                        ...
                                                                                        <div>
                                                                                            <h1 class="text-center"
                                                                                                style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 36px; line-height: 43.2px;"
                                                                                                align="center">Olá </h1>
                                                                                            ...
                                                                                            <h5 class="text-muted  text-center  "
                                                                                                ...
                                                                                                pela sua encomenda.
                                                                                                Ficamos a aguardar o
                                                                                                pagamento da mesma.</h5>
                                                                                            <table class="s-2 w-100"
                                                                                                border="0"
                                                                                                cellpadding="0"
                                                                                                cellspacing="0"
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; margin: 0;"
                                                                                                            align="center"
                                                                                                            bgcolor="#007bff">
                                                                                                            <a href="www.monsuu.pt/encomendas.php"
                                                                                                                style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 4px; line-height: 20px; display: inline-block; font-weight: normal; white-space: nowrap; background-color: #007bff; color: #ffffff; padding: 8px 12px; border: 1px solid #007bff;">Verificar
                                                                                                                Encomenda</a>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
