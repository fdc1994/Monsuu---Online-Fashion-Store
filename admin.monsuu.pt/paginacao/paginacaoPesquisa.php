    ...
    <div class="col-md-6 col-lg-4 mb-3">
        <div class="card w-100 h-100 lead">
            ...
            <div class="card-body">
                <h5 class="card-title">
                    <div class="col-12">
                        <?php echo $row['nome']?> <br><?php if($desconto >0) {?> <div
                            class="discount text-center lead mt-2">-<?php echo($desconto)?>%</div>
                        <?php }?><?php if($row['novidade'] == 1)  {?>
                        <div class="new text-center lead mt-2">Novo</div><?php }?>
                    </div>
                </h5>
                <hr>
                <div class="row">
                ...
                <p class="card-text text-center">
                    ...
                    <span
                        class="text-success h4"><?php echo("Agora: " . number_format($precofinal,2));?>€</span>
                    <br>
                ...
                <div class="row">
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col-lg-5 col-md-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <label
                                                                for="exampleFormControlSelect1">Novidade</label>
                                                        ...
                                                        <div class="col">
                                                            <label
                                                                for="exampleFormControlSelect1">Listado</label>
                                                            <select class="form-control"
                    ...
                    <div class="modal fade" id="modalConfirm<?php echo($row['id'])?>" tabindex="-1"
                        role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered  modal-xl " role="document">
                            <div class="modal-content container-custom">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">Pretende apagar este
                                        produto?
                                    </h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <button type="button" class="btn" data-toggle="modal" data-target="#foto4"><img class="d-block w-75" src="images/produtos/'.$row['foto4'].'" alt="First slide"></button>
                                                    ...
                                                    <a class="carousel-control-prev text-dark"
                                                        href="#carouselDelete<?php echo($row['id'])?>"
                                                        role="button" data-slide="prev">
                                                        <span class="carousel-control-prev-icon"
                                                            aria-hidden="true"></span>
                                                        <span class="sr-only">Previous</span>
                                            ...
                                            <div class="col-lg-5 col-md-12">
                                                ...
                                                <div class="row mt-2">
                                                    <div class="col">
                                                        <label for="exampleInputEmail1">Preço sem Desconto
                                                        </label>
                                                        <input type="text" class="form-control"
                                                            id="exampleInputEmail1"
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <label for="exampleInputEmail1">Preço com Desconto
                                                        </label>
                                                        <input type="text" class="form-control"
                                                            id="exampleInputEmail1"
                                                            value="<?php echo($precofinal)?>€" readonly>
                                    ...
                                    Não é possível reverter esta ação. Terá de adicionar um novo produto se
                                    desejar
                                    que
                                    este produto
                                ...
                                <div class="modal-footer mt-2">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Voltar
                                        Atrás</button>
                                    <a
                                        href="apagarPesquisa.php?pagina=<?php echo($pagina)?>&id=<?php echo $row['id'] ?>&pesquisa=<?php echo $pesquisa?>&orderBy=<?php echo($orderBy)?>"><button
